...
export const SysCommonApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
         * @summary Get all interfaces/dynamic APIs 🔖
        ...
        /**
         * 
         * @summary Download Temporarily Marked Incorrect Excel (Global)
        ...
        /**
         * 
         * @summary Obtain the national secret public key and private key pair 🏆
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ...
        /**
         * 
         * @summary Interface pressure test 🔖
