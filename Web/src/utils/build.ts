...
/**
 * Packaging related
 * Attention prodUrl：usedYes jsdelivr stillYes unpkg。theirs path Maybe notoneTo
 * Article link：https:// blog.csdn.net/qq_34450741/article/details/129766676, using jsdelivr
 * @description importToCDN https://github.com/mmf-fe/vite-plugin-cdn-import
 * @description cdn Introduced online cdn addressConfiguration。path：https://www.jsdelivr.com/ || https://unpkg.com/
 * @description external Packtime，Filter bagimport。Reference：https://rollupjs.org/configuration-options/#external
 */
