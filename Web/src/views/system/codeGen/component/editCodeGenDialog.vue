			...
			<el-form :model="state.ruleForm" ref="ruleFormRef" label-width="auto">
				<el-row :gutter="35">
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="library locator" prop="configId" :rules="[{ required: true, message: 'Please select a library locator', trigger: 'blur' }]">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="library type" prop="dbType" :rules="[{ required: true, message: 'Description cannot be empty', trigger: 'blur' }]">
							<el-select v-model="state.ruleForm.dbType" placeholder="Database type" clearable disabled class="w100">
					...
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="library address" prop="connectionString" :rules="[{ required: true, message: 'Repository address cannot be empty', trigger: 'blur' }]">
							<el-input v-model="state.ruleForm.connectionString" disabled clearable type="textarea" />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="Generate Table" prop="tableName" :rules="[{ required: true, message: 'The generated table cannot be empty', trigger: 'blur' }]">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="Business Name" prop="busName" :rules="[{ required: true, message: 'Business name cannot be empty', trigger: 'blur' } ]">
							<el-input v-model="state.ruleForm.busName" placeholder="Please enter" clearable />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="Generate Menu" prop="generateMenu">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="Menu icon" prop="menuIcon">
							<IconSelector v-model="state.ruleForm.menuIcon" :size="getGlobalComponentSize" placeholder="Menu icon" type="all" />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="Parent menu" prop="menuPid">
							<el-cascader
								:options="state.menuData"
								:props="cascaderProps"
								placeholder="Please select the upper level menu"
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="namespace" prop="nameSpace" :rules="[{ required: true, message: 'Please select a namespace', trigger: 'blur' }]">
							<!-- <el-input v-model="state.ruleForm.nameSpace" clearable placeholder="Please enter" /> -->
							<el-select v-model="state.ruleForm.nameSpace" filterable clearable class="w100" placeholder="namespace">
								<el-option v-for="(item, index) in props.applicationNamespaces" :key="index" :label="item" :value="item" />
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="Frontend directory" prop="pagePath" :rules="[{ required: true, message: 'The frontend directory cannot be empty', trigger: 'blur' }]">
							<el-input v-model="state.ruleForm.pagePath" clearable placeholder="Please enter" />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="Author's Name" prop="authorName">
							<el-input v-model="state.ruleForm.authorName" clearable placeholder="Please enter" />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="Generation method" prop="generateType">
                            <g-sys-dict v-model="state.ruleForm.generateType" code="code_gen_create_type" render-as="select" class="w100" filterable />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="Supports printing" prop="printType">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20" v-if="state.ruleForm.printType == 'custom'">
						<el-form-item label="Print template" prop="printName">
					...
					<el-divider border-style="dashed" content-position="center">
						<div style="color: #b1b3b8">Data uniqueness configuration</div>
					</el-divider>
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-button icon="ele-Plus" text type="primary" plain @click="() => state.ruleForm.tableUniqueList?.push({}) "> Add configuration </el-button>
						<span style="font-size: 12px; color: gray; padding-left: 5px"> Ensure the uniqueness of field values and exclude null values </span>
					</el-col>
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="unique-box">
						<template v-if="state.ruleForm.tableUniqueList != undefined && state.ruleForm.tableUniqueList.length > 0">
                            <div v-for="(v, k) in state.ruleForm.tableUniqueList" :key="k" class="unique-line">
                                <el-form-item label="Field" label-width="55" :prop="`tableUniqueList[${k}].columns`" :rules="[{ required: true, message: `field cannot be empty`, trigger: 'blur' }]">
                                ...
                                <el-form-item label="Description" label-width="55" :prop="`tableUniqueList[${k}].message`" :rules="[{ required: true, message: `Description information cannot be empty`, trigger: 'blur' }]">
									<el-input v-model="state.ruleForm.tableUniqueList[k].message" clearable placeholder="Please enter" />
								</el-form-item>
...
// Table unique constraint configuration item field change event
