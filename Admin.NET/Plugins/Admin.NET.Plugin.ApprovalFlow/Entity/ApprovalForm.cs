...
/// Approval flow form
/// </summary>
[SugarTable(null, "Approval Flow Form")]
public class ApprovalForm : EntityBaseOrg
{
    ...
    /// form properties
    /// </summary>
    [SugarColumn(ColumnDescription = "Form Attributes", Length = 32)]
    public string? FormType { get; set; }

    /// <summary>
    /// form status
    /// </summary>
    [SugarColumn(ColumnDescription = "Form Status")]
    ...
    /// Remark
    /// </summary>
    [SugarColumn(ColumnDescription = "Remarks", Length = 255)]
